  ...
  methods: {
    ...
    changeHandle () {
      if (this.defaultTime[0]) {
        this.value[0] = this.value[0] && this.value[0].replace(` ${this.defaultTime[0]}`, '') + ` ${this.defaultTime[0]}`
      }
      if (this.defaultTime[1]) {
        this.value[1] = this.value[1] && this.value[1].replace(` ${this.defaultTime[1]}`, '') + ` ${this.defaultTime[1]}`
      }
      this.$emit('change')
    }
  }
